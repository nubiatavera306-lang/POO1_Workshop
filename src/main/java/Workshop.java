...
public class Workshop {
    ...
    public int[] rotarArreglo(int[] arreglo, int posiciones) {
        ...
        for (int i = 0; i < longitud; i++) {
            rotado[i] = arreglo[(i + desplazamiento) % longitud];
        }
        return rotado;
    }
...
Rock crushes Scissors
        ...
        switch (jugador1) {
            case "R":
                jugador1Gana = jugador2.equals("S") || jugador2.equals("L");
                break;
            case "P":
                jugador1Gana = jugador2.equals("R") || jugador2.equals("V");
                break;
            case "S":
                jugador1Gana = jugador2.equals("P") || jugador2.equals("L");
                break;
            case "L":
                jugador1Gana = jugador2.equals("V") || jugador2.equals("P");
                break;
            case "V":
                jugador1Gana = jugador2.equals("S") || jugador2.equals("R");
                break;
            default:
                return "Elección inválida";
        }
